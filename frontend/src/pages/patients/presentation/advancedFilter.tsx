...
const AdvancedFilter = ({
  ...
  return (
    <Accordion
      value={open ? '1' : undefined}
      type="single"
      className="w-full border-0 rounded-none overflow-visible"
      collapsible
    >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-x-3 gap-y-2">
                ...
                <FilterInput
                  ...
                  value={filters.affiliationNumber}
                  onChange={set('affiliationNumber')}
                />
                <FilterInput
