            ...
            <FieldGroup>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <Field>
                  ...
                  <Input
                    id="national_id_issued_in"
                    placeholder="e.g. La Paz, California"
                    value={form.national_id_issued_in}
                    onChange={set('national_id_issued_in')}
                    required
                  />
                </Field>
              </div>
            ...
            <FieldGroup>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <SelectField
                  ...
                  onChange={setSelect('education_level')}
                />
                <SelectField
                  id="blood_group"
                  label="Blood Group"
                  ...
                  onChange={setSelect('blood_group')}
                />
              </div>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <Field>
                ...
                <SelectField
                  ...
                  onChange={setSelect('primary_language')}
                />
              </div>
              <Field>
                ...
                <Input
                  ...
                  value={form.indigenous_community}
                  onChange={set('indigenous_community')}
                />
              </Field>
            </FieldGroup>
          </FieldSet>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <Field>
                  ...
                  <Input
                    ...
                    value={form.zone_neighborhood}
                    onChange={set('zone_neighborhood')}
                  />
                </Field>
                <Field>
            ...
            <FieldGroup>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <SelectField
                  id="insurance_type"
                  label="Type"
                  options={options.insuranceType}
                  value={form.insurance_type}
                  onChange={setSelect('insurance_type')}
                />
                <Field>
                  <Label htmlFor="insurance_affiliation_number">Affiliation Number</Label>
                  <Input
                    id="insurance_affiliation_number"
                    value={form.insurance_affiliation_number}
                    onChange={set('insurance_affiliation_number')}
                  />
                </Field>
              </div>
              <Field>
            ...
            <FieldGroup>
              <Field>
                ...
                <Textarea
                  ...
                  onChange={set('administrative_notes')}
                />
              </Field>
            </FieldGroup>
          </FieldSet>
